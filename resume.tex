...
To find a career in software development leveraging my experience and
providing opportunity for it to grow.  My focus is with using software
technologies with the goal of growing into higher-level architecture.
\endsection
\vfil
...
Implemented web-based utility (Servlets/JSPs) for searching telecom carrier
locations in company's proprietary Oracle database.

Designed a single sign-on security framework for JSP/Servlet applications.
Used LDAP services for authentication.  Implemented serveral proof-of-concept
components and used them to gather performance metrics.  Participated in
many planning sessions serving as the technical expert.
\endlist
\vskip .5pc
